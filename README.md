# jsboard
JavaScript library that allows you to easily create lattice styled board games like [Chess](http://danielborowski.com/jsboard/demo/demo8.html) and Conway's [Game of Life](http://danielborowski.com/jsboard/demo/demo9.html).
<br><br>
